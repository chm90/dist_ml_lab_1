...
//    val Array(test,train) = rawDF.randomSplit(Array(0.8,0.2),seed = 1)
...
//      .setNumFolds(10)
//    val cvModel: CrossValidatorModel = cv.fit(rawDF)
//    
...
//    //"rmse = 17.3492056529875)
//    //print rmse of our model
//    println(s"rmse = $rmse")
//    //do prediction - print first k
//    //Without test set this is overfitting, and doesn't really tell anything
////    val testData = ???
////    var res = lrModel.transform(testData)
////    res.select("pred")
  }
}